  ...
  function () {
    ...
    function WindowDatePicker(opt) {
      ...
      if (this.type != HOUR) {
        ...
        this.els.body.innerHTML = "\n                <div class=\"wdp-date-container\">\n                    <div class=\"wdp-date-header\">\n                        <span></span>\n                        <div>\n                            <div>\n                                ".concat(this.renderUpIcon(), "\n                            </div>\n                            <div>\n                                ").concat(this.renderDownIcon(), "\n                            </div>\n                        </div>\n                    </div>\n                    <div class=\"wdp-date-body\">\n                        <div class=\"wdp-week-container\">\n                            <div class=\"wdp-week-header\">\n                                <ul class=\"wdp-week\">\n                                    <li>").concat(this.LANG.DAYS_ABBR[1].substring(0, 3), "</li>\n                                    <li>").concat(this.LANG.DAYS_ABBR[2].substring(0, 3), "</li>\n                                    <li>").concat(this.LANG.DAYS_ABBR[3].substring(0, 3), "</li>\n                                    <li>").concat(this.LANG.DAYS_ABBR[4].substring(0, 3), "</li>\n                                    <li>").concat(this.LANG.DAYS_ABBR[5].substring(0, 3), "</li>\n                                    <li>").concat(this.LANG.DAYS_ABBR[6].substring(0, 3), "</li>\n                                    <li>").concat(this.LANG.DAYS_ABBR[7].substring(0, 3), "</li>\n                                </ul>\n                            </div>\n                            <div class=\"wdp-week-body\"></div>\n                        </div>\n                        <div class=\"wdp-list-container\"></div>\n                        <div class=\"wdp-list-container\"></div>\n                    </div>\n                </div>\n            ");
